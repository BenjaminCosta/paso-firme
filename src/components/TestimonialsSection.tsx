  ...
  return (
    <section className="relative overflow-hidden py-24 px-4">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.85), rgba(227, 216, 204, 0.4)), url('https://images.unsplash.com/photo-1472396961693-142e6e269027?w=1200&h=600&fit=crop')`,
