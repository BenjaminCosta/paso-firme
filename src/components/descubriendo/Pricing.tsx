import { Video, Download, Target, Mic, Zap, Smartphone, Calendar, Clock, DollarSign, ArrowRight, AlertTriangle, ShieldCheck, } from 'lucide-react';
  ...
  const eventDetails = [
    {
      ...
      text: "Sábado 26 de julio",
      urgent: false
    },
    {
      icon: <Clock className="w-5 h-5 text-brand-purple" />,
      text: "10:00 am (CDMX) - 100 min",
      urgent: false
    },
    {
    ...
    },
    {
      ...
      text: "Inversión: $900 MXN (pago único seguro)",
      urgent: false
    }
  ];
    ...
    <section id="pricing"  className="relative py-16 overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-4 max-w-5xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Sección "Lo que incluye" con fondo degradado */}
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1685590950596-a5dcc682e9e6?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjF8fHRlZW4lMjB3aXRoJTIwZnJyaWVuZHN8ZW58MHwxfDB8fHwy')] bg-cover bg-center mix-blend-overlay opacity-30"></div>
...
<div className="bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden relative">
  ...
  <div className="p-6">
    {/* Encabezado con efecto de pulso */}
    ...
    {/* Lista de detalles con efecto de cuenta regresiva */}
    <div className="space-y-4 relative">
      {/* Efecto de tiempo limitado */}
    ...
    {/* Precio destacado con efecto neon */}
    ...
    {/* CTA secundario con efecto hover mejorado */}
    <div className="mt-6">
      <Button 
        variant="outline" 
