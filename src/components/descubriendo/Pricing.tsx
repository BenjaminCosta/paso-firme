...
export const Pricing = () => {
  ...
  // Override temporal para la fecha del 24 de enero de 2026
  const eventDetails = [
    { icon: <Calendar className="w-5 h-5 text-brand-purple" />, text: "24 de enero de 2026" },
    { icon: <Clock className="w-5 h-5 text-brand-purple" />, text: event?.hora || "Por confirmar" },
    { icon: <Clock className="w-5 h-5 text-brand-purple" />, text: `Duración: ${event?.duracion || "90 minutos"}` },
    { icon: <Video className="w-5 h-5 text-brand-purple" />, text: `Plataforma: ${event?.plataforma || "Zoom"}` },
  ];
              ...
              <div className="mt-6 bg-gradient-to-br from-brand-purple/5 to-brand-teal/5 p-5 rounded-xl border-2 border-brand-purple/20 relative overflow-hidden">
                ...
                <div className="relative text-center">
                  ...
                  <div className="flex justify-center gap-2 mt-3">
                    <span className="bg-brand-teal/20 text-brand-teal text-xs font-bold px-3 py-1 rounded-full shadow-md">
                      🔥 Oferta exclusiva
                    </span>
                  </div>
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    <p className="text-xs text-gray-600 font-semibold">
                      📅 Próxima fecha: 24 de enero de 2026
                    </p>
                  </div>
                </div>
              </div>
