  ...
  return (
    <section className="py-20 px-4 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -right-20 -top-20 w-64 h-64 rounded-full bg-brand-teal/5 blur-3xl"></div>
        <div className="absolute -left-20 -bottom-20 w-64 h-64 rounded-full bg-brand-purple/5 blur-3xl"></div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
                Sobre la <span className="bg-gradient-to-r from-brand-teal to-brand-purple bg-clip-text text-transparent">facilitadora</span>
              </h2>
            </div>
            ...
            <div className="space-y-6">
              <div>
                <h3
                  className="text-3xl font-dancing text-brand-teal mb-3"
                  style={{ fontFamily: "'Dancing Script', cursive" }}
                >
                  Olivia Rodríguez
                </h3>
                <div className="h-1 w-16 bg-gradient-to-r from-brand-purple to-brand-teal rounded-full mb-4"></div>
              </div>
              ...
              <div className="space-y-5 text-gray-700 leading-relaxed text-lg">
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  <span className="font-semibold text-brand-teal italic">
                    la adolescencia.
                  </span>
                </p>
              </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 group">
              <div className="flex items-start gap-4">
                <div className="p-2 bg-brand-purple/10 rounded-lg group-hover:bg-brand-purple/20 transition-colors duration-300">
          ...
          <div className="relative">
            <div className="relative group">
              {/* Marco decorativo */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-brand-purple/20 via-brand-teal/10 to-brand-coral/10 transform rotate-2 scale-95 group-hover:rotate-1 group-hover:scale-100 transition-all duration-500"></div>
              ...
              <div className="relative rounded-2xl overflow-hidden bg-white shadow-xl border border-gray-100 transform group-hover:-translate-y-1 transition-transform duration-300">
                ...
                <div className="absolute -bottom-2 -right-2 px-4 py-2 bg-white/20 backdrop-blur-lg text-brand-teal font-semibold rounded-lg shadow-lg">
                  15+ años
                </div>
              </div>
            </div>
