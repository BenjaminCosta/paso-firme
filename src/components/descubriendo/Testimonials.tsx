  ...
  return (
    <section className="relative overflow-hidden py-24 px-4">
      <div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1709216223150-b1b7f75c473b?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
