...
const CTA = ({ onScrollToSection }: CTAProps) => {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/95 via-brand-red/90 to-brand-pink/90" />
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-brand-pink/10 rounded-full blur-3xl transform translate-x-1/2 translate-y-1/2" />
      </div>

      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          {/* Badge */}
          <div className="inline-block bg-white/10 backdrop-blur-sm px-6 py-2 rounded-full mb-8 border border-brand-pink/40">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-white via-white to-brand-pink/90 bg-clip-text text-transparent"> Etapa Importante</span>
          </h2>
