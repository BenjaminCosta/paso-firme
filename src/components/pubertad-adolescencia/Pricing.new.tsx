...
const Pricing = () => {
  ...
  return (
    <div className="space-y-16">
      <section
        id="pricing"
        className="py-16 md:py-24 px-4 sm:px-0 relative overflow-hidden bg-gradient-to-br from-white via-brand-purple/5 to-white"
      >
        {/* Fondos animados más sutiles */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-10% right-10% w-72 h-72 bg-brand-coral/10 rounded-full blur-[100px] animate-float" />
          <div className="absolute bottom-10% left-10% w-80 h-80 bg-brand-teal/10 rounded-full blur-[110px] animate-float-delay" />
          <div className="absolute top-1/3 left-1/3 w-64 h-64 bg-brand-purple/10 rounded-full blur-[90px] animate-float-rotate" />
        </div>
            ...
            <div className="lg:w-1/2 relative group">
              ...
              <Card className="relative bg-white/95 backdrop-blur-md border border-gray-100 shadow-2xl hover:shadow-3xl transition-all duration-300 group-hover:-translate-y-2 overflow-hidden h-full">
                ...
                <CardContent className="p-8 sm:p-10 flex flex-col h-full">
                  ...
                  <div className="mb-8 flex-grow">
                    <div className="space-y-5">
                      <div className="flex items-start gap-5">
                        <div className="p-2.5 bg-brand-purple/10 rounded-xl border border-brand-purple/20 shadow-sm">
                      ...
                      <div className="flex items-start gap-5">
                        <div className="p-2.5 bg-brand-coral/10 rounded-xl border border-brand-coral/20 shadow-sm">
                  ...
                  <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5 bg-gradient-to-r from-brand-purple/5 to-brand-coral/5 p-6 rounded-xl border border-brand-purple/20">
                      <div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="px-2 py-0.5 bg-brand-coral/10 text-brand-coral text-xs font-semibold rounded-full">PRECIO PREVENTA</span>
                          </div>
                        </div>
                    ...
                    <div role="note" aria-live="polite" className="group mt-4 relative rounded-2xl">
                      <div className="absolute -inset-[1px] rounded-2xl bg-gradient-to-r from-brand-coral via-brand-purple to-brand-teal opacity-70 group-hover:opacity-100 blur-[1px] transition-opacity duration-500" />
                      <div className="relative overflow-hidden rounded-[calc(theme(borderRadius.2xl)-1px)] bg-white/90 backdrop-blur-sm border border-brand-coral/20">
                        <div className="relative px-4 sm:px-5 py-3 flex flex-col sm:flex-row sm:items-start gap-3">
                          <div className="flex items-center gap-2 sm:gap-3">
                            <div className="p-2 rounded-xl bg-gradient-to-br from-brand-coral/20 to-brand-purple/20 text-brand-coral shadow-inner ring-1 ring-brand-coral/40">
                              <AlertTriangle className="w-5 h-5 animate-pulse" />
                            </div>
                            <div>
                              <p className="text-[11px] font-semibold tracking-[0.12em] text-brand-coral/90 mb-0.5">
                                OFERTA LIMITADA
                              </p>
                              <p className="text-sm leading-snug text-brand-purple font-medium">
                                Única semana con este <span className="font-bold underline decoration-brand-coral/60 decoration-2 underline-offset-2">precio especial</span>
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex sm:flex-col items-end sm:items-center justify-between sm:justify-start gap-2 sm:gap-1 self-stretch">
                            <div className="px-2.5 py-1 rounded-lg bg-gradient-to-r from-brand-coral to-brand-purple text-white text-[10px] font-bold tracking-wide shadow-lg shadow-brand-purple/25 animate-pulse">
                              AHORA
                            </div>
                            <div className="hidden sm:block text-[10px] font-medium text-brand-coral/80 tracking-wide">
                              No se repite
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="flex flex-col gap-5 w-full mt-auto">
                    ...
                    >
                      <Button 
                        className="w-full py-6 bg-gradient-to-r from-brand-purple to-brand-coral hover:from-brand-purple/90 hover:to-brand-coral/90 text-white font-bold text-lg shadow-xl hover:shadow-2xl transition-all flex items-center justify-center gap-3 group hover:scale-[1.02]"
                        size="lg"
                      >
                    ...
                    <div className="text-center space-y-2">
                      <p className="text-sm text-brand-purple font-medium">
                        <span className="text-brand-coral">💝</span> No esperes a que sea más difícil. Este taller es el paso más claro, amoroso y realista que puedes dar hoy.
                      </p>
                      <p className="text-xs text-gray-500">
                        <Clock className="w-4 h-4 inline mr-1 text-brand-teal" />
