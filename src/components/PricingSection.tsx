              ...
              <CardContent className="p-8 h-full flex flex-col">
                ...
                <div className="space-y-4 mb-8 flex-grow">
                  <div className="flex items-center gap-4 bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-white/30 shadow-sm hover:shadow-md transition-all">
                    ...
                    <span className="text-gray-800 font-medium">Sábado 02 de agosto de 2025</span>
                  </div>
                  <div className="flex items-center gap-4 bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-white/30 shadow-sm hover:shadow-md transition-all">
                    <Clock className="w-6 h-6 text-brand-teal flex-shrink-0" />
                    <span className="text-gray-800 font-medium">10:00 am - 2:00 p.m.</span>
                  </div>
                  <div className="flex items-center gap-4 bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-white/30 shadow-sm hover:shadow-md transition-all">
                    <Users className="w-6 h-6 text-brand-teal flex-shrink-0" />
                    <span className="text-gray-800 font-medium">Incluye kit impreso, dinámicas y experiencia en vivo</span>
                  </div>
                </div>
              ...
              <CardContent className="p-8 h-full flex flex-col">
                ...
                <div className="space-y-4 mb-8 flex-grow">
                  <div className="flex items-center gap-4 bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-white/30 shadow-sm hover:shadow-md transition-all">
                    ...
                    <span className="text-gray-800 font-medium">Jueves 07 y viernes 08 de agosto</span>
                  </div>
                  <div className="flex items-center gap-4 bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-white/30 shadow-sm hover:shadow-md transition-all">
                    <Clock className="w-6 h-6 text-brand-purple flex-shrink-0" />
                    <span className="text-gray-800 font-medium">10:00 - 12:00 cada día</span>
                  </div>
                  <div className="flex items-center gap-4 bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-white/30 shadow-sm hover:shadow-md transition-all">
                    <Download className="w-6 h-6 text-brand-purple flex-shrink-0" />
                    <span className="text-gray-800 font-medium">Vía Zoom en vivo, con guía descargable y acompañamiento</span>
                  </div>
                </div>
        ...
        <div className="mt-10 text-center">
          <div className="inline-flex items-center gap-3 bg-white/90 backdrop-blur-sm border-2 border-brand-coral/20 px-6 py-4 rounded-xl shadow-md hover:shadow-lg transition-all">
            <div className="p-2 bg-brand-coral/10 rounded-full">
              <AlertCircleIcon className="w-7 h-7 text-brand-coral animate-pulse" />
            </div>
            <div>
